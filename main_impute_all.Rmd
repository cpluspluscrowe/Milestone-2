...
library(ISLR)
library(caret)
trControl <- trainControl(method = 'cv', number = 3, savePredictions = TRUE, classProbs = TRUE, summaryFunction = twoClassSummary)#, sampling = 'down')
tuneGrid <- expand.grid(k = 7:20)
